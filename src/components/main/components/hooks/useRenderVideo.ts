...
import { useZoomPrevious, usePersistFn } from '../../../../hooks';
import { isShallowEqual } from '../ZoomSdkService/utils/util';
import { CellLayout } from '../ZoomSdkService/video-types';
import { MediaStream, MeetingParticipants } from '../ZoomSdkService/types';
...
export function useRenderVideo(
  ...
  const previousSubscribedVideos = useZoomPrevious(subscribedVideos);
  const previousLayout = useZoomPrevious(layout);
