...
addActionHandler('setShowHeymateScheduleMiddle', (global, actions, payload) => {
...
addActionHandler('setShowHeymateWalletMiddle', (global, actions, payload) => {
...
addActionHandler('setShowHeymateManageOfferMiddle', (global, actions, payload) => {
...
addActionHandler('setCurrentUserPhoneNumber', (global, actions, payload) => {
...
addActionHandler('setHeymateUser', (global, actions, payload) => {
